          ...
          <div className="header-top">
            ...
            <div className="container">
              ...
              <div className="topbar bg-primary">
                ...
                <div className="dropdown">
                  ...
                  <div className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <div className="quick-search quick-search-dropdown" id="kt_quick_search_dropdown">
                      ...
                      {/*end::Form*/}
                      {/*begin::Scroll*/}
                      <div className="quick-search-wrapper scroll ps" data-scroll="true" data-height={325} data-mobile-height={200} style={{ height: 325, overflow: 'hidden' }}><div className="ps__rail-x" style={{ left: 0, bottom: 0 }}><div className="ps__thumb-x" tabIndex={0} style={{ left: 0, width: 0 }} /></div><div className="ps__rail-y" style={{ top: 0, right: 0 }}><div className="ps__thumb-y" tabIndex={0} style={{ top: 0, height: 0 }} /></div></div>
                      {/*end::Scroll*/}
                    </div>
                  </div>
                  {/*end::Dropdown*/}
                ...
                <div className="dropdown">
                  {/*begin::Toggle*/}
                  <div className="topbar-item" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="false">
                  ...
                  {/*end::Toggle*/}
                  {/*begin::Dropdown*/}
                  <div className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg" style={{}}>
                    <form>
                      {/*begin::Header*/}
